package com.u8.server.sdk.txmsdk.txmsdk;
...
public class SnsSigCheck 
{
     ...
     */
    public static String makeSig(String method, String url_path, Map<String, String> params, String secret) throws OpensnsException
    {
        String sig = null;
        try
        {
     ...
     * @return 签名所需源串
     */
    public static String makeSource(String method, String url_path, Map<String, String> params) throws OpensnsException
    {
